...
var fetchData = function () {
  var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(_ref5) {
    ...
    var type, url, routeResponse, entities, length;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 6;
            return getPages({ url, _perPage, _hostingWPCOM, _auth, _accessToken }, 1);
...
var getPages = function () {
  var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(_ref7) {
    ...
    var result, getOptions, options, _ref9, headers, data, wpTotal, total, totalPages, requests;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 15:
            ...
            return _context4.abrupt("return", Promise.all(requests).then(function (pages) {
...
var httpExceptionHandler = require(`./http-exception-handler`);function getValidRoutes(_ref10) {
  var allRoutes = _ref10.allRoutes,
      url = _ref10.url,
      baseUrl = _ref10.baseUrl,
      _verbose = _ref10._verbose,
      _useACF = _ref10._useACF,
      _hostingWPCOM = _ref10._hostingWPCOM,
      typePrefix = _ref10.typePrefix,
      refactoredEntityTypes = _ref10.refactoredEntityTypes;

  var validRoutes = [];

  for (var _iterator2 = Object.keys(allRoutes.data.routes), _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
    var _ref11;
